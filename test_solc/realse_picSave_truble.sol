...
contract pic_recoder {
    ...
    function set_cache (bytes32 sender,uint list_start,uint list_length)internal constant returns(uint){
    ...
    function user_setlist(bytes32 addr,uint list_start,uint list_length)public{
